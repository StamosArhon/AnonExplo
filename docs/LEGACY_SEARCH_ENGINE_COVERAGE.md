# Historical search engine coverage: VPN audit, 2026-09-09

Superseded by [current coverage](SEARCH_ENGINE_COVERAGE.md). Do not execute the
old backend/rebuild/rollback instructions below; those components are removed.
This file preserves historical measurements only.
