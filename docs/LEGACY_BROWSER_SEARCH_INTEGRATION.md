# Legacy Browser Search Integration (historical, superseded 2026-09-10)

Do not execute the fallback tests or setup recommendations below. This archive
preserves old setup details only. Current browser search is direct 8085 with no
external fallback; use BROWSER_SEARCH_INTEGRATION.md.
