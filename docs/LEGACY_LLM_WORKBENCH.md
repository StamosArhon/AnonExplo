# Legacy LLM Workbench (historical, superseded 2026-09-10)

Former README retained for reference. Paths/commands assume the repo root.
Model provisioning and external fallback are not part of the current product.
